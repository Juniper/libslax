...
typedef struct pin_parse_s {
    ...
    uint8_t *pp_strip_stack;    /* per-depth strip mode (PIN_STRIP_*), heap-allocated */
    uint32_t pp_strip_len;      /* number of entries in use */
    uint32_t pp_strip_size;     /* allocated capacity */
} pin_parse_t;
